...
import { WorkerInstance } from '../src/worker.js';
import { ConcurrencyController } from '../src/concurrency.js';
import { RetryHandler } from '../src/retry_handler.js';
import { DlqHandler } from '../src/dlq_handler.js';
import { HttpExecutionService } from '../src/services/http_execution_service.js';
import { CpuComputeService } from '../src/services/cpu_compute_service.js';
import { NotificationExecutionService } from '../src/services/notification_execution_service.js';
...
test('Worker: DlqHandler classifies error and creates AI Diagnostic Summary', async () => {
  ...
  const summary = DlqHandler.generateAIDiagnosticSummary(err, { job_type: 'http_request' });
